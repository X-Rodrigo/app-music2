    ...
    useEffect(() => {
        try {
            ...
            const options = {
                method: 'GET',
                headers: {
                        'X-RapidAPI-Key': 'a5fc78539dmshfa0787d9ff6d2c0p107c41jsn4dca55b16ce5',
                        'X-RapidAPI-Host': 'deezerdevs-deezer.p.rapidapi.com'
                    }
                }
                const response = await fetch(`https://deezerdevs-deezer.p.rapidapi.com/search?q=track:${buscar}&limit=10`,options);
